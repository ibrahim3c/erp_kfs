        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualArrivalTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    LateMinutes = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsTransferredToPenalty = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LateEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LateEntries_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalSchema: "HR",
                        principalTable: "Employees",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PermissionRequests_Employees_EmployeeId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LateEntries_EmployeeId_Date",
                schema: "HR",
                table: "LateEntries",
                columns: new[] { "EmployeeId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_LateEntries_EmployeeId_IsTransferredToPenalty",
                schema: "HR",
                table: "LateEntries",
                columns: new[] { "EmployeeId", "IsTransferredToPenalty" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionRequests_EmployeeId_Date",
                schema: "HR",
                table: "PermissionRequests",
                columns: new[] { "EmployeeId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_PermissionRequests_EmployeeId1",
                schema: "HR",
                table: "PermissionRequests",
                column: "EmployeeId1");
