...
namespace HR.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20260428215810_FirstMigration")]
            ...
            modelBuilder.Entity("HR.Domain.Employees.Employee", b =>
                {
                    ...
                    b.HasOne("Organization.Domain.JobGrade", null)
                        .WithMany()
                        .HasForeignKey("JobGradeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Organization.Domain.JobTitle", null)
                        .WithMany()
